...
with tab1:
    ...
    with col1:
        st.image("img/Loqueveo/gula2.jpg", caption="Sobre consumo de alimentos, innecesario y contaminante", width=500)
    with col2:
        st.image("img/Loqueveo/supermercado.jpg", caption="Los supermercados generalmente contaminan más que las tiendas pequeñas y naturales," \
...
with tab2:
    ...
    with col1:
        st.image("img/Loqueignoro/fabrica.jpg", caption="Condiciones laborales en fábricas textiles", width=500)
    with col2:
        st.image("img/Loqueignoro/images.jpg", caption="Explotación labora, incluso infantil, desincentivar esto mediante un consumo responsable de" \
...
with tab3:
    ...
    with col1:
        st.image("img/Loqueelijo/caminar.jpg", caption="En vez de contaminar al subirse a un vehiculo, hay que considerar caminar, si las condiciones lo permiten claro", width=500)
    with col2:
        st.image("img/Loqueelijo/econologia.jpg", caption="la economía ecologica, la cual cumple c" \
